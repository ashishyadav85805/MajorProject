...
namespace NGOManagementSystem.Areas.Donor.Controllers
{
    ...
    public class DonorDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderDetailId,DonorId,Amount,CategoryId,PaytmMethod")] DonorDetail donorDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderDetailId,DonorId,Amount,CategoryId,PaytmMethod")] DonorDetail donorDetail)
        {
