...
namespace NGOManagementSystem.Areas.Hub.Controllers
{
    ...
    public class PaymentsController : Controller
    {
        ...
        // GET: Hub/Payments/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Hub/Payments/Create
