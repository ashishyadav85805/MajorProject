    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DonorInfo", x => x.DonorId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PaytmId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PaytmMethods = table.Column<string>(type: "varchar(50)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Paytm", x => x.PaytmId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VolunteerId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    VolunteerName = table.Column<string>(type: "varchar(50)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryId = table.Column<int>(nullable: false),
                    PaytmMethod = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DonorDetail_Paytm_PaytmMethod",
                        column: x => x.PaytmMethod,
                        principalTable: "Paytm",
                        principalColumn: "PaytmId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DonorDetailId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DonorId = table.Column<int>(nullable: false),
                    BankName = table.Column<string>(type: "varchar(50)", nullable: false),
                    AccountNO = table.Column<string>(type: "varchar(50)", nullable: false),
                    IFSC = table.Column<string>(type: "varchar(50)", nullable: false),
                    PaytmMethod = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Payment", x => x.DonorDetailId);
                    table.ForeignKey(
                        name: "FK_Payment_DonorInfo_DonorId",
                        column: x => x.DonorId,
                        principalTable: "DonorInfo",
                        principalColumn: "DonorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Payment_Paytm_PaytmMethod",
                        column: x => x.PaytmMethod,
                        principalTable: "Paytm",
                        principalColumn: "PaytmId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DonorDetail_PaytmMethod",
                table: "DonorDetail",
                column: "PaytmMethod");
